...
UPDATE_EVERY = 100      # target updates after every 100 steps
...
class Agent():
    ...
    def step(self, state, action, reward, next_state, done):
        ...
        # looping needed for mutiple agents
        for (s,a,r,sn,d) in zip(state, action, reward, next_state, done) :
#             print(s.shape, a.shape, type(r), sn.shape, type(d));
    ...
    def learn(self, experiences, gamma):
        ...
        # stabilize multi-agent data update
...
#         self.count_update = (self.count_update % UPDATE_EVERY)+ 1;
